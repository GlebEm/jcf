...
public class Solution {
    ...
    public static void printValues(Map<String, String> map) {
        Map<String, String> list = new HashMap<>();//1. Программа должна создавать переменную коллекции Map с типом элементов String, String. Переменная должна быть сразу проинициализирована. напишите тут ваш код
